...
군사 요원, 토지 개관자, 로봇 관리사, 창작자 같은 미래 지향적 직업은 물론
사회복지사, 탐정, 경비 등의 과정도 마련돼 있습니다. 과정을 마치면 해당
직업 **자격증**이 인벤토리에 추가되며, 자격증은 국가마다 인정 여부가 다릅
니다. 예를 들어 도시 계획자 자격증은 인류연합국에서만 통용되지만 탐정
자격증은 범국가적으로 효력이 있습니다.
